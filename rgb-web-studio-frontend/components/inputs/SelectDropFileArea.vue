<template>
	<div class="group file-drop-area relative "
			 :class="{
						'bg-green-200 text-white border-green-500' : isDragOver,
					 	'bg-gray-200 text-gray-500 border-gray-500' : !isDragOver,
					 	'bg-red-100 text-red-500 border-red-500' : !isFileSizeValid && selectedFile
					 }"
	...
	>
		...
		>
		<div class="material-symbols-outlined text-[80px]">
			upload_file
		</div>
		<div class="text-center">
			{{textContent}}
		</div>
		<button class="btn" @click.stop="handleButtonClick"
		:class="{
