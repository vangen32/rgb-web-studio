  ...
  <div class="w-full">
    ...
    <div class="p-6">
      <div class="pb-4 flex items-start gap-2 text-orange-700">
        ...
        <span>
          "Обрання" користувача означає, що наступні дії ви будете робити від
          його імені, Ви можете змінити користувача в будь який момент
        </span>
      </div>
...
watch(currentPage, (newPage) => {
  router.replace({
    name: route.name,
    params: { ...route.params, page: newPage },
  });
  getUsers(newPage);
});
